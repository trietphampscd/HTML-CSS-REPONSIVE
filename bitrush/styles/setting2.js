$(document).ready(function(){
    ...
    var minDay		= [1,11,21,36,51];
    var maxDay		= [10,20,35,50,99999999999];
	var percent 	= [3.6,125,200,500,1000];
	var minMoney 	= [0.01,0.01,0.01,0.01,0.01];
	var maxMoney	= [50,50,50,50,50];
